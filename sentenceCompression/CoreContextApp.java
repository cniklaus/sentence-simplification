	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (String s : sentences) {
				...
				//RelativeClauseExtractor.extractRestrictiveRelativeClauses(sentence, sentence.getOriginal(), true, -1);
				...
				ProperNounsExtractor.extractAdjectivesNounsNNPs(sentence, sentence.getOriginal(), true, -1);
				
				GerundClauseExtractor.extractGerundAfterNNP(sentence, sentence.getOriginal(), true, -1);
				GerundClauseExtractor.extractAccording(sentence, sentence.getOriginal(), true, -1);
				GerundClauseExtractor.extractIncluding(sentence, sentence.getOriginal(), true, -1);
				GerundClauseExtractor.extractGerundAfterWhile(sentence, sentence.getOriginal(), true, -1);
				//GerundClauseExtractor.extractGerundAfterComma(sentence, sentence.getOriginal(), true, -1);
				//GerundClauseExtractor.extractGerundSentenceStart(sentence, sentence.getOriginal(), true, -1);
				GerundClauseExtractor.extractByGerund(sentence, sentence.getOriginal(), true, -1);
				...
				AppositivePhraseExtractor.extractVerbPhraseAppositives(sentence, sentence.getOriginal(), true, -1);
				AppositivePhraseExtractor.extractNounPhraseAppositives(sentence, sentence.getOriginal(), true, -1);
				AppositivePhraseExtractor.extractAdjectivePhraseAppositives(sentence, sentence.getOriginal(), true, -1);
				AppositivePhraseExtractor.extractAdverbialPhraseAppositives(sentence, sentence.getOriginal(), true, -1);
				AppositivePhraseExtractor.extractProperNounPhraseAppositives(sentence, sentence.getOriginal(), true, -1);
			
				
				Punctuation.splitAtColon(sentence, sentence.getOriginal(), true, -1);
				Punctuation.parentheses(sentence, sentence.getOriginal(), true, -1);
